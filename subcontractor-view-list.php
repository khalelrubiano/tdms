    ...
    <div class="modal" id="addModal">
        ...
        <div class="modal-card p-4">
            ...
            <header class="modal-card-head has-background-info">
                <p class="modal-card-title has-text-white"><i class="fa-solid fa-user-group mr-3"></i>Create Account</p>
    ...
    <div class="modal" id="editModal">
        ...
        <div class="modal-card p-4">
            ...
            <header class="modal-card-head has-background-light">
                <p class="modal-card-title has-text-black"><i class="fa-solid fa-user-plus mr-3"></i>Edit Account</p>
